               ...
               echo '
                       <tr>
                          <td class="product-thumbnail">
                            <img src="'.$P_Image.'" alt="Image" class="img-fluid">
                          </td>
                          ...
                          <td>'.$Price.'</td>
                        <td><a href="delete_item.php?deleteid='.$SN.'" style="font-size:20px; color:#111;text-decoration:none;">X</a></td>
               </tr>
                    ...
                    <div class="col-md-7">
                      ...
                      <div class="row mb-3">
                        ...
                        <?php
                            ...
                            echo'
                            <strong class="text-black">$ '.$price.'.00</strong>
                            ';
                           ?>
                      ...
                      <div class="row mb-5">
                        ...
                        <div class="col-md-6 text-right">
                          <strong class="text-black">$ <?php echo$price ?>.00</strong>
                        </div>
                      </div>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Along Mombasa rd, opposite Airtel HQ</p>
